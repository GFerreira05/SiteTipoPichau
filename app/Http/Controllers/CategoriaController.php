...
class CategoriaController extends Controller
{
    ...
    public function salvar_novo(Request $request){
        ...
        $categoria->cat_nome = $request->cat_nomes;         
        $categoria->cat_descricao = $request->cat_descricao; 
        $categoria->save();
    ...
    public function salvar_update(Request $request){
        $id = $request->input("id");
        $categoria = Categoria::find($id);
        $categoria->cat_nome = $request->input("cat_nomes");        
        $categoria->cat_descricao = $request->input("cat_descricao");
        $categoria->save();
        return redirect("/categoria");        
    }
}
