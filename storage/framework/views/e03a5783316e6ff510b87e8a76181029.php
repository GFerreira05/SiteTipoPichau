                        ...
                        <table class="w-full whitespace-no-wrap">
                            ...
                            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800" id="categoryTableBody">
                                ...
                                <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td class="px-4 py-3">
                                        <a href="/categoria/update/<?php echo e($linha['id']); ?>" class="btn btn-success"><li class="fa fa-edit"></li></a>
                                        <a href="/categoria/excluir/<?php echo e($linha['id']); ?>" class="btn btn-danger"><li class="fa fa-trash"></li></a>
                                    </td>
                                </tr>
