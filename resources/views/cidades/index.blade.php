...
<main class="h-full overflow-y-auto">
    <div class="container px-6 mx-auto grid">
        <div class="container px-6 mt-auto mb-auto grid">
                        ...
                        <table class="w-full whitespace-no-wrap" id="datatablesSimple">
                            ...
                            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800" id="categoryTableBody">
                                ...
                                <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td class="px-4 py-3">
                                        <a href="/cidades/update/{{$linha['id']}}" class="btn btn-success"><li class="fa fa-edit"></li></a>
                                        <a href="/cidades/excluir/{{$linha['id']}}" class="btn btn-danger"><li class="fa fa-trash"></li></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
            ...
            <a href="/cidades/novo" class="btn btn-primary">Novo</a>
