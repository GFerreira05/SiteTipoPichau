                    ...
                    <div class="w-full overflow-x-auto">
                        <table id="datatablesSimple">
                            ...
                            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800" id="categoryTableBody">
                                @foreach ($paises as $linha)
                               
                                <tr class="text-gray-700 dark:text-gray-400">
                                    <td class="px-4 py-3">{{ $linha["id"] }}</td>
                                    <td class="px-4 py-3">{{ $linha["nome"] }}</td>
                                    <td class="px-4 py-3">
                                        <a href="/paises/update/{{$linha['id']}}" class="btn btn-success"><li class="fa fa-edit"></li></a>
                                        <a href="/paises/excluir/{{$linha['id']}}" class="btn btn-danger"><li class="fa fa-trash"></li></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
